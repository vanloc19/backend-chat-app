package com.system.device_service.config;
...
public class DBConfig {
    ...
    public MongoClient mongoClient(Environment env) {
        ...
        if (uri == null || uri.isBlank()) {
            throw new IllegalStateException("Missing MongoDB URI. Set DB_DEVICE_URI in .env or environment variables.");
        }
    ...
    public MongoDatabaseFactory mongoDatabaseFactory(MongoClient mongoClient, Environment env) {
        ...
        if (dbName == null || dbName.isBlank()) {
            throw new IllegalStateException("Missing MongoDB database name. Set DB_DEVICE_NAME in .env or environment variables.");
        }
